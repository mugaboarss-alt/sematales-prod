import { n as projects } from "./projects-DfwLZMj1.js";
import { t as Route } from "./work._slug-OqE53K8C.js";
import { t as SmoothScroll } from "./SmoothScroll-C3_qiIse.js";
import { n as Reveal, r as Nav, t as Footer } from "./Footer-DgmZ7P9i.js";
import { useEffect } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/routes/work.$slug.tsx?tsr-split=component
var RATIOS = [
	"aspect-[4/3]",
	"aspect-[3/4]",
	"aspect-[3/4]",
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx("div", {
				...
				children: images.map((src, i) => /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx("figure", {
			...
			/* @__PURE__ */ jsxs("main", { children: [
				/* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "mx-auto max-w-[1600px]",
						children: [
							/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Link, {
								to: "/",
								hash: "work",
							...
							/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", { children: [
									...
									project.tag,
									"]"
								] }), project.year && /* @__PURE__ */ jsxs("span", {
									className: "text-black/40",
									children: ["· ", project.year]
								})]
							}) }),
							/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx("h1", {
								className: "mt-6 font-display text-6xl md:text-8xl lg:text-9xl leading-[0.9] tracking-[-0.04em]",
								children: project.name
							}) }),
							project.tagline && /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("dl", {
								...
								children: [
									...
									project.year && /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
										className: "text-xs uppercase tracking-[0.25em] text-black/40 mb-3",
										children: "Year"
									}), /* @__PURE__ */ jsx("dd", {
										className: "text-base md:text-lg",
									...
									project.outcome && /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
										className: "text-xs uppercase tracking-[0.25em] text-black/40 mb-3",
										children: "Impact"
									}), /* @__PURE__ */ jsx("dd", {
						...
						children: [/* @__PURE__ */ jsx(Reveal, {
							...
							children: /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: project.scope.map((s) => /* @__PURE__ */ jsx("li", { children: s }, s))
								})]
							})] })
						})]
					})
				...
				restParas.length > 0 && /* @__PURE__ */ jsx("section", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Reveal, {
							...
							children: /* @__PURE__ */ jsx("div", { children: restParas.map((para, i) => /* @__PURE__ */ jsx("p", {
